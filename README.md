...
**19 个号，其中 17 个是国产大模型厂商的官方号。** 这条线的价值在于：
国产厂商的官网普遍是 SPA 且几乎全都没有 RSS（实测 MiniMax、百川、
阶跃星辰、零一万物、面壁、腾讯混元、百度、讯飞无一例外），
**一手发布实际走的就是公众号**。

智谱清言 · Kimi 开放平台 · 月之暗面 Kimi · 千问大模型 · 零一万物 01AI ·
MiniMax 稀宇科技 · 百川智能 · 阶跃 StepFun · 面壁智能 · 字节跳动 Seed ·
腾讯混元 · 百度文心 · 讯飞开放平台 · DeepSeek · 昆仑万维 · 智源研究院 ·
商汤科技 · 量子位 · 机器之心

账号全部写死 `fakeid` 而不是按名字搜，这是**正确性问题不是优化**——
实测搜「智谱AI」命中的是个 2022 年就停更的同名号，搜「Kimi」命中的是
2018 年一个讲电影票的无关号。顺带每轮请求数减半（19 次而不是 38 次），
而搜索正是公众平台上最容易触发风控的动作。

查号用 `python -m sourcepilot.channels.wechat.lookup <名字>`，
